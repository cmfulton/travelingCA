import itertools
import time
from kaggle_data_processor import KaggleDataProcessor
...
def tokenize(file_name):
    ...
    return [sorted(list(set(e.split(",")))) for e in
            open(file_name, encoding='utf-8').read().strip(",").split('\n')]
...
if __name__ == "__main__":
    ...
    # data_processor.write(data, filename)

    # measure could be all, conf, lift or conv
    measure = "conf"
    main(filename, measure)